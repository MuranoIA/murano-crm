...
export default function Chat() {
  ...
  const vendedoresComConversa = [...new Set(vendFiltro ? [...vendedores.map((v) => v.slug), ...comConversa] : comConversa)]
    ...
    .map((slug) => ({
      ...
      // O numero so vale para a carteira que o servidor mandou. Simulando um
      // vendedor, a lista vem estreitada por ele -- contar as outras daria zero
      // e a tela prometeria vazio onde ha conversa.
