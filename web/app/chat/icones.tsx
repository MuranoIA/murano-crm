...
const CAMINHOS: Record<string, string[]> = {
  ...
  /** baixar a conversa em PDF — folha com seta, para não repetir o `pegar`,
      que já é uma seta para baixo sobre uma base */
  baixar: ["M14 3H7a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8z", "M14 3v5h5", "M12 11v5.5", "M9.6 14.1l2.4 2.4 2.4-2.4"],
  /** ligar */
