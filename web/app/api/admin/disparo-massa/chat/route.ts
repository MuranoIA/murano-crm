...
function sistema(ctx: {
  ...
  return [
    ...
    `- O teto de UMA campanha é ${LIMITE_MAX} clientes — não é sobre tempo (o envio roda em faixas`,
    "  paralelas, não mais um a um), é só para pegar pedido digitado errado. Se pedirem mais que isso, DIGA na resposta:",
