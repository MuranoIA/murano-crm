...
//
// O corte de 20s acontece no navegador do admin (web/lib/musicaParabens.ts):
...
// teto de 20s no player (e usa <audio>, que ignora o vídeo do container).
const BUCKET = "ranking-musica";
const CHAVE = "parabens_musica";
const SEGUNDOS = 20; // teto de reprodução na TV (não exportar: rota do Next só aceita handlers + config)
