...
export const COLUNAS = [
  ...
  { key: "ociosos", titulo: "Ociosos", status: "Parado", cor: "#94a3b8", sub: "esperando +30 min, ou parado +24h", subLong: "a cliente falou e faz +30 min sem resposta, ou a conversa parou há +24h",
    regras: "Um card cai aqui quando:\n• a CLIENTE falou por último e faz +30 min sem resposta (desde 14/09/2026 — antes eram 24h);\n• a conversa parou há +24h, de quem quer que seja a última fala;\n• uma venda de mês anterior expirou e não houve nada depois.\n\n⚠️ Os dois primeiros pedem coisas DIFERENTES: esperando há 30 min é só responder, e é de graça; parado há +24h fechou a janela do WhatsApp e só um template reabre — e template custa. Olhe a hora da última mensagem antes de disparar.\n\n(Quem nunca foi contatado fica na Lista de prospecção, não aqui.)\n\nAutomação: sai daqui sozinho quando você responde (→ Negociação) ou dispara um template (→ Tentativa de contato).\n\nA coluna é uma foto refeita a cada 2 minutos: um card pode levar até 2 min para aparecer depois de vencer o prazo." },
  ...
  { key: "negociacao", titulo: "Negociação", status: "Em andamento", cor: "#0e9fd6", sub: "conversa em dia", subLong: "cliente respondido, ou que falou agora há pouco",
    regras: "Um card cai aqui quando:\n• a cliente falou por último há menos de 30 min (ainda dá tempo de responder sem ela esperar);\n• ou você falou por último, fora de template, há menos de 24h.\n\nAutomações:\n• alerta vermelho 'AGUARDA RESPOSTA' se a cliente falou por último e você está +10 min sem responder (some ao clicar no card, volta se ela mandar msg nova);\n• ela esperando +30 min → Ociosos;\n• a conversa parada +24h → Ociosos;\n• fechou venda → Pedido Emitido." },
